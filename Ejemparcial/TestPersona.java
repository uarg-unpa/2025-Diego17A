...
public class TestPersona {
    ...
    System.out.println(p1.vivenEnLaMismaCalle(p2.getDomicilio())); // true, porque ambos
    //tienen calle "San Martín"
    System.out.println("¿Juan y Pedro viven en la misma calle?");
    System.out.println(p1.vivenEnLaMismaCalle(p3.getDomicilio())); // false, porque uno
    //vive en "San Martín" y otro en "Belgrano"
    }
    } 
